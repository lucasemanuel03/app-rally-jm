...
function Index() {
  ...
  return (
    <div>
      ...
      <div className='mt-10 animate-fade-in-down animate-delay-1000'>
        <div className="grid grid-cols-2 gap justify-items-center items-center justify-center max-w-3xl mx-auto gap-2 ">
